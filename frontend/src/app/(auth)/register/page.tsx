    ...
    <div className="min-h-screen bg-slate-100">
      <div className="grid min-h-screen lg:grid-cols-2">
        <section className="relative hidden overflow-hidden lg:flex">
          <div className="absolute inset-0 bg-gradient-to-br from-violet-600 via-blue-600 to-sky-500" />
          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-10 text-white">
            ...
            <div className="max-w-lg">
              ...
              <h1 className="mt-6 text-5xl font-extrabold leading-tight">
                Empieza a gestionar tu productora con una experiencia más clara y moderna
              </h1>

              <p className="mt-5 text-lg leading-8 text-white/85">
                Registra tu equipo, crea proyectos, organiza documentos y mantén el control de
                producción desde un solo panel.
              </p>

              <div className="mt-8 grid grid-cols-3 gap-3">
                <div className="rounded-2xl bg-white/12 p-4 backdrop-blur">
                  <div className="text-2xl font-extrabold">1</div>
                  <div className="mt-1 text-sm text-white/80">Cuenta principal</div>
                </div>
                <div className="rounded-2xl bg-white/12 p-4 backdrop-blur">
                  <div className="text-2xl font-extrabold">Org</div>
                  <div className="mt-1 text-sm text-white/80">Tu productora</div>
                </div>
                <div className="rounded-2xl bg-white/12 p-4 backdrop-blur">
                  <div className="text-2xl font-extrabold">Go</div>
                  <div className="mt-1 text-sm text-white/80">Empieza rápido</div>
                </div>
              </div>
            </div>

            <div className="text-sm text-white/70">
              Registro pensado para productores y equipos creativos.
            </div>
          </div>
        </section>
        ...
        <section className="flex items-center justify-center p-6 md:p-10">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl md:p-8">
              <div className="mb-6">
                <div className="inline-flex rounded-full bg-violet-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-violet-600">
                  Nueva cuenta
                </div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Registra tu productora para comenzar a trabajar en WEZET.
                </p>
              </div>
              ...
              <form onSubmit={onSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full rounded-2xl bg-gradient-to-r from-violet-600 to-blue-600 px-4 py-3.5 text-sm font-bold text-white shadow-sm transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-60"
                >
              ...
              <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-500">
                Esta cuenta se creará como productora principal y será la base de tu organización.
              </div>
